	...
	<body>
		<div>
			...
			<?php
				...
				/*Le quito el else ya que se muestra al iniciar el php*/
			?>
			<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				<label for="num1">Operador1</label></br>
				<input type="text" name="num1" value="<?php if(!empty($_POST["num1"]))echo ($_POST["num1"]); ?>"></br>
				<label for="num2">Operador2</label></br>
				<input type="text" name="num2" value="<?php if(!empty($_POST["num2"]))echo ($_POST["num2"]); ?>"></br>
				</br>
				<div>
					<fieldset>
